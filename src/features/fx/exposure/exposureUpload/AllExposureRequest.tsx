...
const AllExposureRequests = () => {
  ...
  const getChangedFields = (original: AllExposureRequest, edited: AllExposureRequest) => {
    ...
    for (const key in edited) {
      const typedKey = key as keyof AllExposureRequest;
      if (original[typedKey] !== edited[typedKey]) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <NyneOSTable<AllExposureRequest>
        table={table}
        columns={columns}
...
export default AllExposureRequests;
