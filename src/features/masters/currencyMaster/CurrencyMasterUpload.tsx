...
import { templates,currencyMasterValidationConfig} from "./config.ts";
...
//   const [selectedType, setSelectedType] = useState("");
  ...
  const handleFiles = async (fileList: FileList) => {
    ...
    const processFile = async (file: File, fileData: UploadedFile) => {
      try {
        const validationConfig = currencyMasterValidationConfig;
      ...
      <div className="space-y-6">
        ...
        {files.length > 0 && (
          <UploadSummaryItem
            ...
            validationConfig={currencyMasterValidationConfig}
